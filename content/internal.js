...
function handleInternal() {
  //Determines which content should be displayed in the internal page according to the id passed from the clicked element.
  let currentUrl = window.location.href;
  if (currentUrl.includes("englishSG")) {
    document.getElementById("main-frame").src =
      "./loc_style_guides/Localization Style Guide - EN/VTEXLocalizationStyleGuideEN.html";
    expandItem("styleGuides");
  } else if (currentUrl.includes("spanishSG")) {
    document.getElementById("main-frame").src =
      "./loc_style_guides/Localization Style Guide - ES/VTEXLocalizationStyleGuideES.html";
    expandItem("styleGuides");
  } else if (currentUrl.includes("portugueseSG")) {
    document.getElementById("main-frame").src =
      "./loc_style_guides/Localization Style Guide - PT/VTEXPortugueseStyleGuidePT.html";
    expandItem("styleGuides");
  } else if (currentUrl.includes("EnMktSG")) {
    document.getElementById("main-frame").src =
      "./marketing_style_guides/Writing Style Guide - EN/VTEXWritingStyleGuideEN.html";
    expandItem("styleGuides");
  } else if (currentUrl.includes("EsMktSG")) {
    document.getElementById("main-frame").src =
      "./marketing_style_guides/Writing Style Guide - ES/WritingStyleGuideES.html";
    expandItem("styleGuides");
  } else if (currentUrl.includes("PtMktSG")) {
    document.getElementById("main-frame").src =
      "./marketing_style_guides/Writing Style Guide - PT/VTEXWritingStyleGuidePT.html";
    expandItem("styleGuides");
    ...
    document.getElementById("main-frame").src =
      "./loc_admin_review_logs/Admin String Standardization - EN/VTEXAdminstringstandardizationinEnglish.html";
    expandItem("reviewLogs");
  } else if (currentUrl.includes("esAdminStd")) {
    displayReviewLogsHeader(); //Changes the header to match the selected section/card.
    document.getElementById("main-frame").src =
      "./loc_admin_review_logs/Admin String Standardization - ES/VTEXAdminstringstandardizationinSpanish.html";
    expandItem("reviewLogs");
  } else if (currentUrl.includes("ptAdminStd")) {
    displayReviewLogsHeader(); //Changes the header to match the selected section/card.
    document.getElementById("main-frame").src =
      "./loc_admin_review_logs/Admin String Standardization - PT/VTEXAdminstringstandardizationinPortuguese.html";
    expandItem("reviewLogs");
    ...
    document.getElementById("main-frame").src =
      "./localization_and_internationalization/naming_guidelines.html";
...
function displayGlossariesHeader() {
  //Changes the header and subheader to match the selected card/section.
  let headerText = document.getElementById("header-text");
  headerText.innerText = "Glossaries";
  let headerSubtext = document.getElementById("header-subtext");
  headerSubtext.innerText =
    "Enhance the user experience by using the most updated and researched VTEX terms in English, Portuguese, and Spanish.";
}

function displayReviewLogsHeader() {
  //Changes the header and subheader to match the selected card/section.
  let headerText = document.getElementById("header-text");
  headerText.innerText = "Admin Review Logs";
  let headerSubtext = document.getElementById("header-subtext");
  headerSubtext.innerText =
    "Check out the linguistic evolution of UI strings towards a native and consistent experience.";
}

function displayL10nAndI18nHeader() {
  //Changes the header and subheader to match the selected card/section.
  let headerText = document.getElementById("header-text");
...
function expandItem(id) {
  //Determines which menu subsection should be open on load depending on the selected card.
  if (id == "styleGuides") {
    expandStyleGuides();
...
function expandStyleGuides() {
  ...
  if (list) {
    ...
    let items = [
      {
        id: "StyleGuides",
        text: "Back to Style Guides",
        link: "./style_guides.html",
      },
      {
        id: "Documentation",
        text: "Documentation",
        link: "https://www.notion.so/vtexhandbook/E-D-Style-Guide-80cf41f627574419bde54e64aa04d1df",
      },
      {
        id: "englishSG",
        text: "EN Localization",
        link: "./internal.html?id=englishSG",
      },
      {
        id: "spanishSG",
        text: "ES Localization",
        link: "./internal.html?id=spanishSG",
      },
      {
        id: "portugueseSG",
        text: "PT Localization",
        link: "./internal.html?id=portugueseSG",
      },
      {
        id: "EnMktSG",
        text: "EN Marketing",
        link: "./internal.html?id=EnMktSG",
      },
      {
        id: "EsMktSG",
        text: "ES Marketing",
        link: "./internal.html?id=EsMktSG",
      },
      {
        id: "PtMktSG",
        text: "PT Marketing",
        link: "./internal.html?id=PtMktSG",
      },
      {
        id: "UXWriSG",
        text: "UX Writing",
        link: "https://uxwriting.vtex.com/",
      },
    ];
...
function collapseStyleGuides() {
  //Removes the generated elements of the section from the DOM, collapsing the card.
  let item = document.getElementById("styleGuides");
  let list = item.querySelector("ul");
  let icon = document.querySelector("#collapseStyleGuides");
    ...
    let items = [
      {
        id: "glossaries",
        text: "Localization",
        link: "./internal.html?id=glossaries",
      },
    ];
...
function expandL10nAndI18nMemories() {
  ...
  if (list) {
    ...
    let items = [
      {
        id: "namingGuidelines",
        text: "Naming Guidelines",
        link: "./internal.html?id=namingGuidelines",
      },
    ];
...
function expandReviewLogs() {
  ...
  if (list) {
    ...
    let items = [
      {
        id: "enAdminStd",
        text: "EN Admin Standardization",
        link: "./internal.html?id=enAdminStd",
      },
      {
        id: "esAdminStd",
        text: "ES Admin Standardization",
        link: "./internal.html?id=esAdminStd",
      },
      {
        id: "ptAdminStd",
        text: "PT Admin Standardization",
        link: "./internal.html?id=ptAdminStd",
      },
    ];
...
function toggleMenu() {
  //Changes the menu icon and title text as it opens or closes the menu.
